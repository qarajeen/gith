    ...
    const handlePrint = () => {
        ...
        if (logoDataUri) {
            try {
                ...
                // Fail silently if the logo fails to load
            }
        }
